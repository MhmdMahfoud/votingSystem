...
<body>
    <div class="form-container">
        <h2>Create New Jury</h2>
        <form action="process_jury.php" method="POST">
            <div class="form-row">
            ...
            <div class="form-group">
                <label for="sponsor_guest">Sponsor/Guest:</label>
                <select id="sponsor_guest" name="sponsor_guest" required>
